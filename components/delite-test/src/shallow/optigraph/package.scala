...
package object optigraph {
  ...
  def InDFS(g: Graph, from: Node, block: Node => Unit, inPost: Node => Unit)(implicit o: Overloaded1.type): Unit = ???
  ...
  def InBFS(g: Graph, from: Node, block: Node => Unit, inReverse: Node => Unit)(implicit o: Overloaded1.type): Unit = ???
