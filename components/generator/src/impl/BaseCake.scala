...
/**
 * BaseCake with ManifestBased.
 */
trait BaseCakeManifest extends BaseCake with ManifestBased

/**
 * BaseCake with TypeTag.
 */
trait BaseCakeTypeTag extends BaseCake with TypeTagBased